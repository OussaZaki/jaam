...
export const Loader: React.SFC<LoaderProps> = ({ active }) => {
    const animatedValue = new Animated.Value(0);

    const setTimingAnimated = (originalValue: Animated.Value, newValue: number, duration: number) => Animated.timing(originalValue, {
        toValue: newValue,
        duration,
